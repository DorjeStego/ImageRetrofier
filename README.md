...
## Example commands
* `python3 /src/main.py --input-filename "/home/dorje/Public/retrofier/some-image.jpg" --output-filename "/home/dorje/Public/retrofier/output.jpg" --tile-size 4 --transform pixel --n-colours 16 --flatten-passes 6 --flatten-ms 5 --dither none --verbose`
